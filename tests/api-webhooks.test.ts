...
describe('handleWebhooksRoutes', () => {
  ...
  beforeEach(async () => {
    ...
    createWebhookMock.mockResolvedValue({
      id: 'wh1', connectionId: 'conn1', url: 'https://x.com',
  ...
  it('GET /connections/:id/webhooks — lista webhooks', async () => {
    ...
    const handled = await handleWebhooksRoutes(
      makeReq('GET', '/connections/conn1/webhooks') as never,
      res as never,
  ...
  it('POST /connections/:id/webhooks — cria webhook', async () => {
    const res = makeRes()
    const handled = await handleWebhooksRoutes(
      makeReq('POST', '/connections/conn1/webhooks', { url: 'https://x.com', eventsFilter: ['*'] }) as never,
      res as never,
      '/connections/conn1/webhooks',
      stubLogger as never,
    )
  ...
  it('POST /connections/:id/webhooks — retorna 400 sem url', async () => {
    ...
    await handleWebhooksRoutes(
      makeReq('POST', '/connections/conn1/webhooks', { eventsFilter: ['*'] }) as never,
      res as never,
      '/connections/conn1/webhooks',
      stubLogger as never,
    )
  ...
  it('POST /connections/:id/webhooks — retorna 400 sem eventsFilter', async () => {
    const res = makeRes()
    await handleWebhooksRoutes(
      makeReq('POST', '/connections/conn1/webhooks', { url: 'https://x.com' }) as never,
      res as never,
      '/connections/conn1/webhooks',
      stubLogger as never,
    )
  ...
  it('GET /connections/:id/webhooks/:wid — 404 quando não encontrado', async () => {
    const res = makeRes()
    const handled = await handleWebhooksRoutes(
      makeReq('GET', '/connections/conn1/webhooks/nope') as never,
      res as never,
      '/connections/conn1/webhooks/nope',
      stubLogger as never,
    )
    expect(handled).toBe(true)
  ...
  it('GET /connections/:id/webhooks/:wid — retorna webhook existente', async () => {
    ...
    const res = makeRes()
    await handleWebhooksRoutes(
      makeReq('GET', '/connections/conn1/webhooks/wh1') as never,
      res as never,
  ...
  it('PATCH /connections/:id/webhooks/:wid — atualiza webhook', async () => {
    ...
    const res = makeRes()
    await handleWebhooksRoutes(
      makeReq('PATCH', '/connections/conn1/webhooks/wh1', { url: 'https://new.com' }) as never,
      res as never,
      '/connections/conn1/webhooks/wh1',
      stubLogger as never,
    )
  ...
  it('PATCH /connections/:id/webhooks/:wid — 404 quando não encontrado', async () => {
    ...
    const res = makeRes()
    await handleWebhooksRoutes(
      makeReq('PATCH', '/connections/conn1/webhooks/nope', { active: false }) as never,
      res as never,
      '/connections/conn1/webhooks/nope',
      stubLogger as never,
    )
  ...
  it('DELETE /connections/:id/webhooks/:wid — 204 ao deletar', async () => {
    ...
    const res = makeRes()
    await handleWebhooksRoutes(
      makeReq('DELETE', '/connections/conn1/webhooks/wh1') as never,
      res as never,
      '/connections/conn1/webhooks/wh1',
      stubLogger as never,
    )
  ...
  it('DELETE /connections/:id/webhooks/:wid — 404 quando não encontrado', async () => {
    ...
    const res = makeRes()
    await handleWebhooksRoutes(
      makeReq('DELETE', '/connections/conn1/webhooks/nope') as never,
      res as never,
      '/connections/conn1/webhooks/nope',
      stubLogger as never,
    )
  ...
  it('GET /connections/:id/webhooks/:wid/deliveries — lista entregas', async () => {
    ...
    const res = makeRes()
    const handled = await handleWebhooksRoutes(
      makeReq('GET', '/connections/conn1/webhooks/wh1/deliveries') as never,
      res as never,
      '/connections/conn1/webhooks/wh1/deliveries',
      stubLogger as never,
    )
    expect(handled).toBe(true)
    expect(res.statusCode).toBe(200)
